...
function NinjaSlider(a) {
    ...
    var d = "length",
        ...
        Ab = function(c) {
            ...
            if (a && a[d]) {
                var b = a[d];
                while (b--) a[b].nodeType != 1 && a[b][o].removeChild(a[b])
            }
        },
        B = function(a, c, b) {
    ...
    M = "ontouchstart" in window || window.DocumentTouch && k instanceof DocumentTouch || v;
    var pb = function() {
            if (M) {
                ...
                gb = {
                    ...
                    b: function(a) {
                        if (!v && (a.touches[d] > 1 || a.scale && a.scale !== 1)) return;
                        ...
                        if (x === null) x = !!(x || Math.abs(s.x) < Math.abs(s.y));
                        if (!x) {
                            bb(a);
                            R();
                            b[c][e].left = s.x + "px"
                    ...
                    c: function() {
                        ...
                        f.removeEventListener(z, this, false);
                        f.removeEventListener(A, this, false)
                    }
                };
                f[r](D, gb, false)
            }
    ...
    g.a = yb();
    var Gb = function(a) {
            for (var c, e, b = a[d]; b; c = parseInt(C() * b), e = a[--b], a[b] = a[c], a[c] = e);
            return a
        },
        Fb = function(a, c) {
            var b = a[d];
        ...
        ob = function() {
            ...
            var d = g.p + "transform:translateX(0)",
                ...
                f = e + "-";
            p("sl-cl", d, f + b + ")", "li.sl-cl", c);
            p("sl-cr", d, e + b + ")", "li.sl-cr", c);
            p("sl-sl", e + b + ")", d, "li.sl-sl", c);
            p("sl-sr", f + b + ")", d, "li.sl-sr", c);
            if (a.c == "slide") {
                b = "100%";
                p("sl-cl2", d, f + b + ")", "li.sl-cl2", c);
                p("sl-cr2", d, e + b + ")", "li.sl-cr2", c);
                p("sl-sl2", e + b + ")", d, "li.sl-sl2", c);
                p("sl-sr2", f + b + ")", d, "li.sl-sr2", c)
            }
            m(" li[class*='sl-'] {opacity:1;__transition:opacity 0ms;}")
        },
        S = function() {
            m(".fullscreen{z-index:2147483640;top:0;left:0;bottom:0;right:0;width:100%;padding:0;height:100%;position:fixed;text-align:center;overflow:auto;}");
            ...
            m(".fullscreen>div{display:inline-block;vertical-align:middle;width:85%;}");
        ...
        zb = function(c, m) {
            if (c.lL === undefined) {
                ...
                if (l[d]) {
                    for (var h = [], b, j, i, f = 0; f < l[d]; f++) E(l[f], "ns-img") && h.push(l[f]);
                    if (h[d]) b = h[0];
                    else c.lL = 0;
                    if (h[d] > 1) {
                        for (var f = 1; f < h[d]; f++) {
                            i = h[f].getAttribute("data-screen");
                            if (i) {
                                i = i.split("-");
                                if (i[d] == 2) {
                                    if (i[1] == "max") i[1] = 9999999;
                                    if (o >= i[0] && o <= i[1]) {
                                        b = h[f];
                                        break
                                    }
                        ...
                        for (var f = 0; f < h[d]; f++)
                            if (h[f] !== b) h[f][e].display = "none"
                    }
                    if (b) {
                        c.lL = 1;
                        if (b.tagName == "A") {
                            j = b.getAttribute("href");
                            B(b, "click", bb)
                        } else if (b.tagName == "IMG") j = b.getAttribute("src");
                        else {
                            var k = b[e].backgroundImage;
                            if (k && k.indexOf("url(") != -1) {
                                k = k.substring(4, k[d] - 1).replace(/[\'\"]/g, "");
                                j = k
                            }
                        }
                        if (j) {
                            if (a.c == "zoom" || a.c == "kb") c.nI = b
                        } else c.lL = 0;
                        var g = new Image;
                        ...
                        if (Eb(g)) {
                            y(c, "loading");
                            ab(g.naturalWidth, g.naturalHeight, c);
                            m === 1 && L();
                            if (b.tagName == "A") b[e].backgroundImage = "url('" + j + "')";
                            g = null
                        } else {
                            g.is1 = m === 1;
                            g.mA = b;
        ...
        L = function() {
            ...
            B(window, "resize", xb);
            B(k, "visibilitychange", Hb)
        },
        X = function(a) {
            if (l && l.playAutoVideo) l.playAutoVideo(a);
            else typeof nsVideoPlugin == "function" && n(function() {
                X(a)
            }, 300)
        },
        xb = function() {
        ...
        ub = function() {
            (new Function("a", "b", "c", "d", "e", "f", "g", "h", "i", "j", function(c) {
                ...
                return b.join("")
            }("zev$NAjyrgxmsr,|0}-zev$eAjyrgxmsr,~-zev$gA~_fa,4-2xsWxvmrk,-?vixyvr$g2wyfwxv,g2pirkxl15-\u0081?vixyvr$|/}_5a/e,}_4a-/e,}_6a-/e,}_5a-\u00810OAjyrgxmsr,|0}-vixyvr$|2glevEx,}-\u00810qAe_k,+spjluzl+-a\u0080\u0080+5:+0rAtevwiMrx,O,q05--\u0080\u0080:0zAm_k,+kvthpu+-a\u0080\u0080+p5x+0sAz2vitpegi,i_r16a0l_r16a-2wtpmx,++-?j2tAh,g-?mj,q%AN,+f+/r0s--zev$vAQexl2verhsq,-0w0yAk,+Upuqh'Zspkly'{yphs'}lyzpvu+-?mj,v@27-wAg_na_na2tvizmsywWmfpmrk?mj,v@2:**%w-wAg_na_na_na?mj,w**w2ri|xWmfpmrk-wAw2ri|xWmfpmrk\u0081mj,vB2=-wAm2fsh}?mj,O,z04-AA+p+**O,z0z2pirkxl15-AA+x+-wA4?mj,w-w_na2mrwivxFijsvi,m_k,+jylh{l[l{Uvkl+-a,y-0w-\u0081"))).apply(this, [a, N, f, Db, kb, g, jb, lb, document, o])
        },
        j = function(c, b) {
            a.o && clearTimeout(O);
        ...
        Hb = function() {
            if (a.d)
                if (u) {
                    if (l.iframe && l.iframe[o][e].zIndex == "1964") {
                        u = false;
                        return
                    }
                    n(G, 2200)
    ...
    var eb = function(l) {
            ...
            if (a.o) {
                ...
                f.onmouseout = function() {
                    if (d.iframe && d.iframe[o][e].zIndex == "1964") return;
                    O = n(function() {
                        j(c + 1, 1)
                    }, 2e3)
                }
        ...
        nb = function(a) {
            ib.innerHTML = hb.innerHTML = "<div>" + (a + 1) + " &#8725; " + w + "</div>";
            if (t[d]) {
                var b = t[d];
                while (b--) t[b][i] = "";
                t[a][i] = "active"
        ...
        db = function(d, j) {
            ...
            if (j != 9)
                if (a.c == "slide" || a.m && j) {
                    ...
                    var l = d > c || !d && c == w - 1;
                    if (!c && d != 1 && d == w - 1) l = 0;
                    var k = a.c == "slide" && f[o][o].offsetWidth == f[o].offsetWidth ? "2" : "";
                    if (l) {
                        q(b[c], "sl-cl" + k);
                        q(b[d], "sl-sl" + k)
                    } else {
    ...
    eb.prototype = {
        ...
        addNavs: function() {
            ...
            if (!Z(l)[d]) {
                for (var n = [], b = 0; b < w; b++) n.push('<a rel="' + b + '">' + (b + 1) + "</a>");
                l.innerHTML = n.join("")
            }
            t = Z(l);
            for (var b = 0; b < t[d]; b++) {
            ...
            Q[i] = "paused";
            var h = f[o][o].getElementsByTagName("*"),
                m = h[d];
            if (m)
                for (var b = 0; b < m; b++)
                    if (E(h[b], "fs-icon")) {
            ...
            if (g) {
                ...
                B(k, "keydown", function(a) {
                    a.keyCode == 27 && E(f[o][o], "fullscreen") && g.click()
                })
            }
        },
        sliderId: a.b,
